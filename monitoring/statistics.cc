...
const std::vector<std::pair<Tickers, std::string>> TickersNameMap = {
    ...
    // {GET_MISS_L0, "rocksdb.l0.miss"},
    // {GET_MISS_L1, "rocksdb.l1.miss"},
    // {GET_MISS_L2, "rocksdb.l2.miss"},
    // {GET_MISS_L3, "rocksdb.l3.miss"},
    // {GET_MISS_L4, "rocksdb.l4.miss"},
    // {GET_MISS_L5, "rocksdb.l5.miss"},
    {GET_RMISS_L0, "rocksdb.l0.miss"},
    {GET_RMISS_L1, "rocksdb.l1.miss"},
    {GET_RMISS_L2, "rocksdb.l2.miss"},
    {GET_RMISS_L3, "rocksdb.l3.miss"},
    {GET_RMISS_L4, "rocksdb.l4.miss"},
    {GET_RMISS_L5, "rocksdb.l5.miss"},
